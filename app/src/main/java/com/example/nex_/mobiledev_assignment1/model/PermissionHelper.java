...
import com.example.nex_.mobiledev_assignment1.view.PermissionActivity;
...
// Written by Caspar for MAD, sem 2 2018
public class PermissionHelper
{
    ...
    /**
     * @param activity    - the PermissionActivity associated with this class
     *                     which overrides onRequestPermissionsResult(...) and forwards
     *                    to this class based on requestCode
     * @param msgView     - a view to display the required snackBar messages (usually main view of activity)
     * @param requestCode - a request code that matches these permissions
     * @param rationale   - an explanatory rationale String explaining the use of these permissions
     * @param permissions - one or more permissions (usually a related set per operation) required by the app
     */
    public PermissionHelper(PermissionActivity activity, View msgView, int requestCode,
